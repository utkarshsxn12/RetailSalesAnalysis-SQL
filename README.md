...
This project demonstrates essential SQL skills used in data analysis. It includes database creation, data cleaning, exploratory data analysis (EDA), and solving real-world business problems using SQL queries.
